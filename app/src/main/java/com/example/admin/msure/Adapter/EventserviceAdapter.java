...
public class EventserviceAdapter extends RecyclerView.Adapter<EventserviceAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public EventserviceAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.eventservice_layout, parent, false);

        //view.setOnClickListener(All_serviceActivity.myOnClickListener);
