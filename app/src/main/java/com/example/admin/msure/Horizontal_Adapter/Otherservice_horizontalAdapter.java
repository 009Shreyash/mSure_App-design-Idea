...
public class Otherservice_horizontalAdapter extends RecyclerView.Adapter<Otherservice_horizontalAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public Otherservice_horizontalAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.otherservice_horizontal_layout, parent, false);
