...
public class BeautyserviceAdapter extends RecyclerView.Adapter<BeautyserviceAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public BeautyserviceAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.beautyservice_layout, parent, false);
