...
public class Businessservice_horizontalAdapter extends RecyclerView.Adapter<Businessservice_horizontalAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public Businessservice_horizontalAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.businessservices_horizontal_layout, parent, false);
