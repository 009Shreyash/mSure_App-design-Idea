...
public class Homeservice_Adapter extends RecyclerView.Adapter<Homeservice_Adapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public Homeservice_Adapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.homeservice_layout, parent, false);
