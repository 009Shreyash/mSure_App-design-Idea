...
public class Beautyservice_horizontalAdapter extends RecyclerView.Adapter<Beautyservice_horizontalAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public Beautyservice_horizontalAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.beautyservice_horizontallayout, parent, false);
