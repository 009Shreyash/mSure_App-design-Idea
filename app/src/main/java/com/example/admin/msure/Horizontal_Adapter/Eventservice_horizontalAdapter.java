...
public class Eventservice_horizontalAdapter extends RecyclerView.Adapter<Eventservice_horizontalAdapter.MyViewHolder>
{
    private ArrayList<DataModel> dataSet;

    public Eventservice_horizontalAdapter(ArrayList<DataModel> dataSet) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.eventservice_horizontal_layout, parent, false);
